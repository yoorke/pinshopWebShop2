    ...
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void rptPromotions_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if(e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ((Literal)slider.FindControl("lblPrev1")).Text = @"<a id=""prev" + ((HiddenField)e.Item.FindControl("lblPromotionID")).Value + @""" href=" + "#carousel" + ((HiddenField)e.Item.FindControl("lblPromotionID")).Value + @" data-slide=""prev""><span class='fa fa-fw fa-chevron-circle-left direction-icon product-slider-button product-slider-button-prev'></span></a>";
                ((Literal)slider.FindControl("lblNext1")).Text = @"<a id=""next" + ((HiddenField)e.Item.FindControl("lblPromotionID")).Value + @""" href=" + "#carousel" + ((HiddenField)e.Item.FindControl("lblPromotionID")).Value + @" data-slide=""next""><span class='fa fa-fw fa-chevron-circle-right direction-icon product-slider-button product-slider-button-next'></span></a>";
