<%@ Page Title="" Language="C#" MasterPageFile="~/webShop.Master" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="WebShop2.products" EnableViewState="false" %>
<%@ Register Src="userControls/PagerV2.ascx" TagName="Pager" TagPrefix="pager" %>
        ...
        <div class="product-filter">
            ...
            <div id="filterBrandsDiv" runat="server">
                ...
                <div class="filter-box">
                    <asp:CheckBoxList ID="chkBrands" runat="server" OnSelectedIndexChanged="chkBrands_SelectedIndexChanged" EnableViewState="false"></asp:CheckBoxList>
                </div>
            </div>

            <h2>Cena</h2>
            <div class="filter-box">
                <label class="before">Od:</label><asp:DropDownList ID="cmbPriceFrom" runat="server" OnSelectedIndexChanged="cmbPriceFrom_SelectedIndexChanged" EnableViewState="false"></asp:DropDownList><label><small>din</small></label><br />
                <label class="before">Do:</label><asp:DropDownList ID="cmbPriceTo" runat="server" OnSelectedIndexChanged="cmbPriceTo_SelectedIndexChanged" EnableViewState="false"></asp:DropDownList><label><small>din</small></label>
            </div>
            <asp:Repeater ID="rptFilter" runat="server" EnableViewState="false">
                <ItemTemplate>
                    <h2><asp:Literal ID="lblFilterName" runat="server" Text='<%#Eval("nameScreen") %>'></asp:Literal></h2>
                    <asp:HiddenField ID="lblAttributeID" runat="server" Value='<%#Eval("attributeID") %>' EnableViewState="false" />
                    <div class="filter-box">
                        <asp:CheckBoxList ID="chkValues" runat="server" DataSource='<%#Eval("values") %>' DataTextField="value" DataValueField="attributeValueID" OnSelectedIndexChanged="chkValues_SelectedIndexChanged" EnableViewState="false"></asp:CheckBoxList>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
        </div>
                ...
                <div class="col-lg-7">
                    <div class="row sort">
                        <div class="col-sm-6 col-xs-12">
                            <div role="form" class="form-horizontal">
                                <div class="form-group">
                                    <label for='<%=cmbPageSize.ClientID %>' class="col-xs-8 control-label">Po stranici:</label>
                                    <div class="col-xs-4 padding-left-0">
                                        <asp:DropDownList ID="cmbPageSize" runat="server" OnSelectedIndexChanged="cmbPageSize_SelectedIndexChanged" CssClass="form-control" EnableViewState="false"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                            <div role="form" class="form-horizontal">
                                <div class="form-group">
                                    <label for='<%=cmbSort.ClientID %>' class="col-xs-5 control-label">Sort:</label>
                                    <div class="col-xs-7 padding-left-0">
                                        <asp:DropDownList ID="cmbSort" runat="server" OnSelectedIndexChanged="cmbSort_SelectedIndexChanged" CssClass="pull-right form-control" EnableViewState="false"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
